...
while($row = mysqli_fetch_array($result)) { 
  echo "<tr>";
  echo "<td align='center'>"."<img src='fileupload/".$row["fileupload"]."
        ' width='250'>"."</td>";
...
//หัวข้อตาราง
    ...
    if (mysqli_num_rows($result) > 0) {
      while($row = mysqli_fetch_assoc($result)) {
        ...
        //echo "<td>".$row["time"]."</td> ";
        echo "<td align='center' ><a href='Parent_show.php?idnumber=$row[idnumber]'><i class='fas fa-address-card'style='font-size:25px'></i></a></td> ";
