...
$_sql ="SELECT * FROM uploadfile WHERE namestudent 
         LIKE '%$name%' ORDER BY namestudent ASC";
...
<div class="navbar">
  ...
  <div class="subnav">
    ...
    <?php if (isset($_SESSION ['id'])) : ?>     
        <p style="color: #000000;" > Welcome <strong style="color: #000000;">
...
<h2>นักเรียน</h2>
    ...
    <div class="fakeimg" style="height:200px;">รูปนักเรียน</div>
...
$name= $_POST["search"];
$_sql ="SELECT * FROM uploadfile WHERE namestudent LIKE '%$name%' ORDER BY namestudent ASC";
//3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result . 
$result=mysqli_query($con,$_sql);
 echo "<table class='Table'>";//หัวข้อตาราง
  echo "<tr >
  <th>ลำดับ</th>
  <th>รหัสนักเรียน</th>
  <th>ชื่อนักเรียน</th>
 ...
 while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td>" .$row["nameparent"] .  "</td> ";
            echo "<td>" .$row["phonenumber"] .  "</td> ";
            echo "<td>" .$row["carnumber"] .  "</td> ";
            echo "<td align='center' ><a href='searchData_show.php?idnumber=$row[idnumber]'>
            <i class='fas fa-address-card'style='font-size:25px'></i></a></td> ";
            echo "<td align='center' ><a href='edit.php?idnumber=$row[idnumber]'>
            <i class='fas fa-edit'style='font-size:25px'></i></a></td> ";
            echo "<td align='center' ><a href='delete_file_db.php?idnumber=$row[idnumber]'>
            <i class='fas'style='font-size:25px'onclick='return confirm ('คุณต้องการลบข้อมูลหรือไม่')'>&#xf1f8;</i></a></td>";
...
<div class="side">
<h2>ป้ายทะเบียนรถ</h2> 
    <div class="fakeimg" style="height:200px;">รูปป้ายทะเบียนรถ</div>
