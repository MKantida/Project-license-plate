...
text-align: center;
font-size: 16px;
border: 2px solid #1C6EA4;/*เส้นขอบใหญ่*/
...
while($row = mysqli_fetch_array($result)) { 
  ...
  echo "<td align='center' ><a href='Information_show.php?idnumber=$row[0]'><i class='fas fa-address-card'style='font-size:25px'></i></a></td> ";
  echo "<td align='center' ><a href='edit.php?idnumber=$row[0]'><i class='fas fa-edit'style='font-size:25px'></i></a></td> ";
  echo "<td align='center' ><a href='delete_file_db.php?idnumber=$row[0]'><i class='fas'style='font-size:25px'onclick='return confirm ('คุณต้องการลบข้อมูลหรือไม่')'>&#xf1f8;</i></a></td>";
  echo "</tr>";
}
echo "</table>";
//5. close connection
