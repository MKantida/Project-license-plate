  ...
  <h2>เพิ่มข้อมูล:</h2>
      <h3>ส่วนของนักเรียน:</h3>
          ...
          <div class="input-group">
              ...
              <input type="file" name="carpicture" id="carpicture"  required="required">
          </div>
              <label ><b>เลขทะเบียนรถ</b></label>
              <input type="text" name="carnumber" id="carnumber">
          </div>
          <div class="input-group">
              <button type="submit" name="button" id="button" value="Upload"class="btn" 
              onclick="alert('ยันยืนการเพิ่มข้อมูล')" >เพิ่มข้อมูล</button>
