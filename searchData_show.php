...
$result = mysqli_query($con, $sql); 
  ...
  <th>ลบข้อมูล</th>
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td align='center' ><a href='searchData_show.php?idnumber=$row[idnumber]'><i class='fas fa-address-card'style='font-size:25px'></i></a></td> ";
            echo "<td align='center' ><a href='edit.php?idnumber=$row[idnumber]'><i class='fas fa-edit'style='font-size:25px'></i></a></td> ";
            echo "<td align='center' ><a href='delete_file_db.php?idnumber=$row[idnumber]'><i class='fas'style='font-size:25px'onclick='return confirm ('คุณต้องการลบข้อมูลหรือไม่')'>&#xf1f8;</i></a></td>";
